...
const Blog = () => {
    return (
        <div>
            <h3 className='questions'>What is the purpose of react router?</h3>
            Ans:
            ...
            <h3 className='questions'>How does context API works?</h3>
            Ans:
            ...
            <h3 className='questions'>how does useref work?</h3>
            Ans:
